...
class Button_Play():
    def __init__(self, ai_game, msg):
        ...
        self.rect.x = self.settings.screen_width / 2 - 120
...
class Button_Settings():
    def __init__(self, ai_game, msg):
        ...
        #Построение объекта rect кнопки и выравнивание по центру экрана.
        self.rect = pygame.Rect(0, 0, self.width, self.height)
        self.rect.x = self.settings.screen_width / 2 - 620
...
class Buttons:
    class Language:
         def __init__(self, ai_game, msg):
             ...
             #Построение объекта rect кнопки и выравнивание по центру экрана.
             self.rect = pygame.Rect(0, 0, self.width, self.height)
             self.rect.x = self.settings.screen_width / 2 - 10
...
class Exit:
    def __init__(self, ai_game, msg):
        ...
        #Построение объекта rect кнопки и выравнивание по центру экрана.
        self.rect = pygame.Rect(0, 0, self.width, self.height)
        self.rect.x = self.settings.screen_width / 2 + 390
